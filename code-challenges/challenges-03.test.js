...
const alphabetizeBetter = (arr) => {
  arr.sort((a, b) => a.toUpperCase().localCompare(b.toUpperCase()));
  return arr;
};

// I used a stack overFlow solution to find "localCompare" https://stackoverflow.com/questions/8996963/how-to-perform-case-insensitive-sorting-in-javascript.
...
const sortPeople = (arr) => {
  arr.sort((a, b) =>
    a.lastName.toUpperCase().localCompare(b.lastName.toUpperCase())
  );
  return arr;
};
// still using local compare method I learned from stackover flow. couldn't get it to work without the upperCase method
